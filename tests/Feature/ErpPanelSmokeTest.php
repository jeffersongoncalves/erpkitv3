...
it('renders the core ERP Filament list pages for an authenticated admin', function (string $route) {
    ...
    'companies' => 'filament.admin.resources.companies.companies.index',
    'accounts' => 'filament.admin.resources.accounts.accounts.index',
    'items' => 'filament.admin.resources.items.items.index',
    'customers' => 'filament.admin.resources.customers.customers.index',
    'sales-invoices' => 'filament.admin.resources.sales-invoices.sales-invoices.index',
]);
