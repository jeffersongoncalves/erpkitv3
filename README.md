...
![ERPKit v3](https://raw.githubusercontent.com/jeffersongoncalves/erpkitv3/main/art/jeffersongoncalves-erpkitv3.png)

</div>

# ERPKit v3

A full ERP, ready to run — a Laravel 12 + Filament v3 starter application with a multi-panel,
